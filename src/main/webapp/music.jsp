...
<html>
    ...
    <body>
        <%List<Event> eventsList = new EventsDAO().findEventsByCategory("music");%>
        ...
        <div class="row carousel-holder">
            <div id="carousel-example-generic" class="carousel slide"data-ride="carousel" style="height: 300px; overflow: hidden">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <img class="slide-image" src="img/m2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="slide-image" src="img/m3.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="slide-image" src="img/m4.jpg" alt="">
                    </div>
                </div>

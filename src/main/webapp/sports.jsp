<%-- 
    Document   : music
    Created on : May 23, 2015, 3:25:05 PM
    Author     : Topo
--%>
...
<html>
    ...
    <body>
        <%List<Event> eventsList = new EventsDAO().findEventsByCategory("sport");%>
            ...
            <div id="carousel-example-generic" class="carousel slide"data-ride="carousel" style="height: 300px; overflow: hidden">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img class="slide-image" src="img/s1.jpg"  alt="">
                    </div>
                    <div class="item">
                        <img class="slide-image" src="img/s2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="slide-image" src="img/s3.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="slide-image" src="img/s4.jpg" alt="">
                    </div>
                </div>

...
<html>
    ...
    <body>
        <%List<Event> eventsList = new EventsDAO().findAllEvents();%>
    ...
    <div class="seatgeek-splash">
        ...
        <div id="carousel-example-generic" class="carousel slide"data-ride="carousel" style="height: 250px; overflow: hidden">
